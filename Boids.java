...
public class Boids extends JPanel {
  ...
  private void spawnFlock() {
    flock = Flock.spawn(-300, h * 0.5, 500); // Increase the number of birds to 50
    for (Boid boid : flock.boids) {
      // Set the color of each bird to green
      boid.color = Color.GREEN;
    }
  }
...
class Boid {
  ...
  Color color;
  boolean included; // Added variable
  ...
  void draw(Graphics2D g) {
    ...
    g.setColor(color); // Set color here
    g.fill(shape);
